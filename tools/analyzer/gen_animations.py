...
def build_animations(skeleton, storyboard, tier_gains=None, tier_combo_hits=None, tier_wobble_cycles=None):
    ...
    G-4''''':squash(cat∈COUPLED_SCALE_CATS)的 scale 為耦合非均勻(scaleX·scaleY≡1)→ 幅度增益走
    **體積守恆耦合 amplify**(amplify_anim(coupled=True)),擠壓隨檔位加狠而體積守恆不破。
    ...
    for beat in storyboard["beats"]:
        ...
        if tier_gains and cat in _MAIN_SHOW_CATS:
            ...
            # G-4''''':squash 的 scale 為耦合非均勻(體積守恆)→ 需耦合 amplify,否則放大破壞 scaleX·scaleY≡1。
