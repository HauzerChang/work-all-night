...
# (G-4'''''')twist(雙軸對角絞擰)加入:第三個 shear 產出者,且是**第一個填 shearY 通道**者
# (wobble/squash 皆 shearY≡0)。列入 SHEAR_CATS 使 shear-isolation 閘認定其為合法 shear 產出者。
# **honest boundary**:twist 尚未併入 MAIN_SHOW_CATS(未接 tier 幅度差異化)—— 留作下一步
# (比照 G-4' 當時 wobble 亦先只產通道、tier 由 G-4'' 補;amplify_bone_tl 對 shear.y 已 g*v 就緒)。
