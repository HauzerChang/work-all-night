...
| `tools/mesh_gen/` | **研究產出的工具本體**(mesh 生成器 / 評估器 / PSD 切圖 / atlas)——上游開發源頭。 |
| `skills/spine-ai-editor/` | **可安裝 Skill(git 版控)**:把研究成果(資產前處理 pipeline)併入既有 spine-ai-editor 的第 6 能力主軸,讓 cowork / chat 直接用最新技術。安裝見其 `INSTALL.md`。 |
| (其他) | 實際的研究產出 / 程式碼(目標開發)。 |
