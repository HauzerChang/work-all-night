...
- [S4 PSD-first 切圖契約](s4-psd-contract.md) — 使用者拍板走 PSD 契約。完成 psd_slice.py(PSD→各部位件+manifest)+ 自驗閘 + 合成 fixture;4 層 PSD 重組 MAE=0.01/0孤兒,漏層負對照抓到。含給美術的交檔規範。**待真實 PSD 驗收**。
