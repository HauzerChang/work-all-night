...
- [S3 端到端對照 Award 真實 mesh](s3-award-mesh-end-to-end.md) — **里程碑**:機器人 3 mesh 件(光暈/身體/左手)過 S3 → 對照 Award 藝術家真實 mesh,靜態覆蓋率/拓樸/精簡度**全 pass**(gen IoU 0.978~0.988 vs 藝術家 0.968~0.980)。發現並修:v1 預設 epsilon 0.008 對大件/軟邊太粗(改 0.003)+ 三角過濾後孤兒頂點(加 prune_orphans)。deform 閘 N/A(weighted+無 deform timeline,已確認)。
