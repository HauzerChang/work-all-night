...
- [S3 端到端對照 Award 真實 mesh](s3-award-mesh-endtoend.md) — **里程碑**:PSD 件→generate_mesh_v2→對照 Award 生產 mesh(光暈/身體/左手)覆蓋率全達/超藝術家,頂點省 40~60%,靜態 AC 全過。發現 IoU 純由 hull 密度決定(v1/v2 一致);blob-fallback epsilon 0.008→0.004、加 orphan 清理。
