...
- [S3 生成 mesh vs Award 真實 mesh](s3-vs-award-real-mesh.md) — **端到端「件→mesh」對真實生產標的驗收**:光暈/身體/左手三件,S3 生成 mesh 覆蓋率達/超藝術家(0.98)且頂點少 32–55%。發現**覆蓋率由 hull epsilon 決定、內部點無關**;blob 路徑加覆蓋率驅動 epsilon 精修(`target_cov`);strip 路徑無回歸。
