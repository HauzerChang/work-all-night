...
工作板塊 **W1~W5 全部完成(2026-07-03)**,軌跡 51.6→71.2(扣眼內件資訊極限後實際 recall 0.89):
W1 評分器(GT=100/負對照全抓)→ W2 重疊架構(掏空根治)→ W3 邊緣吸附(per-piece snap)
→ W4 粒度(臉部套件/地標定位/薄件緊縮)→ W5 收斂(基底+覆蓋/z 歸屬/alpha 繼承)。
定版 `acceptance/dj_cat_ai_final.psd`;詳見 knowledge/s4-w1w2-overlap-reseg.md、
s4-w3w4-edge-snap.md、s4-w4b2-face-kit.md、s4-w5-final.md。使用者將擇期二次驗證。
